...
namespace b2c_ms_graph { 
    ...
    class UserService
    {
        ...
        public static async Task<IGraphServiceUsersCollectionPage> ListUsers(GraphServiceClient graphClient)
        {
        ...
        public static IGraphServiceUsersCollectionRequest  ListUsers2(GraphServiceClient graphClient)
        {
